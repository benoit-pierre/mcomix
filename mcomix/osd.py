...
class OnScreenDisplay(object):
    ...
    def _clear_osd(self):
        ...
        crect.x, crect.y, crect.width, crect.height = self._last_osd_rect
    ...
    def _draw_osd(self, layout, rect):
        ...
        cr.set_source_rgb(*constants.GTK_GDK_COLOR_BLACK.to_floats())
        cr.rectangle(*rect)
        cr.fill()
        extents = layout.get_extents()[0]
        cr.set_source_rgb(*constants.GTK_GDK_COLOR_WHITE.to_floats())
